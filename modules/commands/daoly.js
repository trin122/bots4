...
setTimeout(() => {a({body: "Xin phép mở đầu thì" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "Ở Xã Hội Này" + " " + name, mentions: arraytag})}, 5000);
setTimeout(() => {a({body: "Chỉ Có Làm" + " " + name, mentions: arraytag})}, 7000);
setTimeout(() => {a({body: "Chịu Khó" + " " + name, mentions: arraytag})}, 9000);
setTimeout(() => {a({body: "Cần Cù Thì Bù Siêng Năng" + " " + name, mentions: arraytag})}, 11000);
setTimeout(() => {a("Chỉ Có Làm Mới Có Ăn")} , 13000);
setTimeout(() => {a({body: "Cái Loại Không Làm Mà Đòi Có Ăn " + " " + name, mentions: arraytag})}, 15000);
setTimeout(() => {a({body: "Thì Ăn Đầu Puồi , Ăn Cứt" + " " + name, mentions: arraytag})}, 17000);
setTimeout(() => {a({body: "Nhặt Được Của Rơi Thì Còn Cái Nịt Nhé , Bye Hết Rồi Nhé :))" + " " + name, mentions: arraytag})}, 19000);
setTimeout(() => {a("Chào tạm biệt 🥺 lew lew")} , 20000);
}